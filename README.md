...
## TODOUn Rest API con una lista de contactos
* 
...
* Al registrar cualquiera de los campos debe tener las validaciones en todos los cambios, como validaciones de numeros de telefono,
 correo electronico, campos que sea de solo texto o solo numero.
